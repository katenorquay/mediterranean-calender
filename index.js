...
const initialState = {
  ...
  calendar: [
    ...
    {name: 'Sunday',
    times: [
      {id:1, title:'morning', x: 7, y: 0, hasEmoji: false},
      {id:2, title: 'late morning', x: 7, y: 1, hasEmoji: false},
      {id:3, title:'lunch', x: 7, y: 2, hasEmoji: false},
      {id:4, title: 'afternoon', x: 7, y: 3, hasEmoji: false},
      {id:5, title: 'late afternoon', x: 7, y: 4, hasEmoji: false},
      {id:6, title: 'dinner', x: 7, y: 5, hasEmoji: false}
    ]}
  ],
  emojis: {
    1: {
